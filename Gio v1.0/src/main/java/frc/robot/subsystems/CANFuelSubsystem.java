...
public class CANFuelSubsystem extends SubsystemBase {
  ...
  public CANFuelSubsystem() {
    ...
    feederConfig.CurrentLimits.withSupplyCurrentLimit(FEEDER_MOTOR_CURRENT_LIMIT);
    ...
    // launcherConfig.invert(true);
    launcherConfig.CurrentLimits.withSupplyCurrentLimit(LAUNCHER_MOTOR_CURRENT_LIMIT);
    // intakeLauncherRoller.mainConfig = getFXConfig();
